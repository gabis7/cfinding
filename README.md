...
This an implementation of the Johnson's circuit finding algorithm [*]. The code is a translation from Java code to C++ of the Algorithm avaiable in :  [http://normalisiert.de](https://github.com/josch/cycles_johnson_meyer)
